...
import com.refactoring_guru.memento.commands.ColorCommand;
import com.refactoring_guru.memento.commands.MoveCommand;
...
public class Canvas extends java.awt.Canvas {
    ...
    private void createFrame() {
        ...
        content.add(new JLabel("Select and drag to move."), BorderLayout.PAGE_END);
        content.add(new JLabel("Right click to change color."), BorderLayout.PAGE_END);
        content.add(new JLabel("Undo: Ctrl+Z, Redo: Ctrl+R"), BorderLayout.PAGE_END);
        content.add(this);
